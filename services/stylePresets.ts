import type { CalloutZone, ImageCalloutsContent, ViewAngle, SideViewVariant, FrontViewVariant } from '../types';

export type PresetPose = 'side1' | 'side2' | 'back' | 'mood' | 'front' | 'push_up' | 'zoom' | 'mockup';
...
const toPresetPose = (raw: string): PresetPose | null => {
  ...
  const lookup: Record<string, PresetPose> = {
    ...
    side: 'side1', side_view: 'side1', side_shoot: 'side1', side_image: 'side1', side_shot: 'side1', side_shot_1: 'side1', side_shoot_1: 'side1', side_image_1: 'side1',
    // Side View 2
    side2: 'side2', side_view_2: 'side2', side_2: 'side2', sideview2: 'side2', side_image_2: 'side2', side_shot_2: 'side2', side_shoot_2: 'side2',
    // Back
    back: 'back', back_view: 'back', back_shot: 'back', back_shoot: 'back', back_image: 'back',
    // Mood
    mood: 'mood', mood_shot: 'mood', mood_shoot: 'mood', lifestyle: 'mood', lifestyle_shot: 'mood', lifestyle_shoot: 'mood', mood_image: 'mood', lifestyle_image: 'mood',
    // Front
    front: 'front', front_shoot: 'front', front_view: 'front', front_shot: 'front', front_image: 'front',
    // Front Push-Up
    push_up: 'push_up', front_push_up: 'push_up', pushup: 'push_up', push_up_shoot: 'push_up',
    front_pushup: 'push_up', pushup_shoot: 'push_up', push_up_shot: 'push_up', push_up_image: 'push_up', pushup_image: 'push_up',
    // Zoom
    zoom: 'zoom', zoom_shot: 'zoom', zoom_shoot: 'zoom', zoom_view: 'zoom', closeup: 'zoom', close_up: 'zoom',
    closeup_shot: 'zoom', close_up_shot: 'zoom', closeup_shoot: 'zoom', close_up_shoot: 'zoom', zoom_in: 'zoom',
    detail: 'zoom', detail_shot: 'zoom', detail_view: 'zoom', detail_shoot: 'zoom', macro: 'zoom', macro_shot: 'zoom', zoom_image: 'zoom', closeup_image: 'zoom', close_up_image: 'zoom', detail_image: 'zoom',
    // Mockup
    mockup: 'mockup', mockup_shot: 'mockup', mockup_shoot: 'mockup', mock_up: 'mockup', mock_up_shot: 'mockup', mock_up_shoot: 'mockup', mockup_image: 'mockup', mock_up_image: 'mockup',
    product_mockup: 'mockup', product_mockup_shot: 'mockup', product_mockup_shoot: 'mockup', product_mockup_image: 'mockup',
  };
...
const STORAGE_KEY = 'belle_style_presets_v2';
